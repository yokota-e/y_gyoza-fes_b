...
<body>
    ...
    <h1 class="text-center m-5">削除済みのユーザー一覧</h1>
                    ...
                    <?php foreach ($result as $user): ?>
                        <?php if ($user['is_deleted'] == 1): ?>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <a href="user_restore_do.php?id=<?php echo h($user['id']) ?>" class="btn btn-outline-primary">復元する</a>
                            </li>
                        <?php endif; ?>
                    <?php endforeach; ?>
                <?php endif; ?>
